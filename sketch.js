...
function setup() {
	...
	bob1 = new BOB(210,400,"darkblue");
	bob2 = new BOB(270,400,"blue");
	bob3 = new BOB(330,400,"skyblue");
	bob4 = new BOB(390,400,"skyblue");
	bob5 = new BOB(450,400,"blue");
	bob6 = new BOB(510,400,"darkblue");
